...
public function lista(){
	return $this->execute_query("SELECT * FROM empresa  ;" );
}
*/
...
<html>
    ...
    <div class="container">
        ...
        <blockquote>
          ...
          <small>Utilize os campos abaixo para gerenciar as empresas</small>
        </blockquote>
        ...
        <div class="control-group">
            <div class="controls">
              <a href="edita.php" class="btn btn-info btn-large">Cadastrar uma nova empresa</a>
            </div>
		</div>
