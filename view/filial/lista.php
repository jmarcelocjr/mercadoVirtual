...
public function lista(){
	return $this->execute_query("SELECT * FROM filial  ;" );
}
*/
...
<html>
    ...
    <div class="container">
		...
		<!-- Título -->
        <blockquote>
          <h2>Listagem de filial</h2>
          <small>Utilize os campos abaixo para gerenciar as filiais</small>
        </blockquote>
        ...
        <div class="control-group">
            <div class="controls">
              <a href="edita.php" class="btn btn-info btn-large">Cadastrar nova  filial</a>
            </div>
		</div>
